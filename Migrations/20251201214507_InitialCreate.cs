        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroSecuriteSociale = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroLicence = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ServiceId = table.Column<int>(type: "int", nullable: false),
                    DateEmbauche = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Medecins", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Medecins_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Medecins_MedecinId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medecins_NumeroLicence",
                table: "Medecins",
                column: "NumeroLicence",
                unique: true,
                filter: "[NumeroLicence] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Medecins_ServiceId",
                table: "Medecins",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Patients_NumeroSecuriteSociale",
                table: "Patients",
                column: "NumeroSecuriteSociale",
                unique: true,
                filter: "[NumeroSecuriteSociale] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_RendezVous_MedecinId_DateHeure",
                table: "RendezVous",
                columns: new[] { "MedecinId", "DateHeure" });
